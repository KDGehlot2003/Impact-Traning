...
--
-- Table structure for table `EVS_TBL_Party`
--
...
--
-- Dumping data for table `EVS_TBL_Party`
--

LOCK TABLES `EVS_TBL_Party` WRITE;
/*!40000 ALTER TABLE `EVS_TBL_Party` DISABLE KEYS */;
/*!40000 ALTER TABLE `EVS_TBL_Party` ENABLE KEYS */;
UNLOCK TABLES;
